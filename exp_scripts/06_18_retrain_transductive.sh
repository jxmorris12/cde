...
torchrun --nproc_per_node 8 finetune.py --per_device_train_batch_size 256 \
                        ...
                        --use_prefix 1 \
                        --transductive_corpus_size 256 \
                        --save_steps 16000 \
                        --logit_scale 50 \
                        --max_eval_batches 4 \
                        --exp_name 2024-06-18-transductive-pretrain-13 \
                        --ddp_share_negatives_between_gpus 1 \
                        --max_batch_size_fits_in_memory 96 \
			--use_wandb 0 --overwrite_output_dir
