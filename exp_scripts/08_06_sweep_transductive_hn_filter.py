...
args_dict = {
    ...
    # "hn_tune_threshold": [0.55, 0.6, 0.65, 0.7, 0.75],
    "hn_tune_threshold": [0.8, 0.85, 0.9, 0.95, -1],
    "batch_size": [2048],
    ##############################################################
    "epochs": [3],
    "learning_rate": [2e-5],
