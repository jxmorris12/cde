...
args_dict = {
    ...
    "cluster_size": [131072],
    "batch_size": [2048],
    "transductive_sequence_dropout_prob": [0.0, 0.01, 0.05, 0.1, 0.15, 0.2, 0.25, 0.5],
    ##############################################################
    "epochs": [3],
    "learning_rate": [2e-5],
}
