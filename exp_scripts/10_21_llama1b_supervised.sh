...
CMD=" \
    finetune.py --per_device_train_batch_size 256 --per_device_eval_batch_size 256 \
                 ...
                 --exp_name 2024-10-21-supervised-pretrain-llama-1b-5 \
                 --exp_group 2024-10-21-supervised-pretrain-llama-1b-5 \
                 ...
                 --model_state_dict_from_path /fsx-checkpoints/jxm/cde/2024-10-17-llama-1b-pretrain-4/
    "
