...
command_str = "torchrun --nproc_per_node 8 finetune.py --per_device_train_batch_size {batch_size} --per_device_eval_batch_size 256 --use_wandb 1 --dataset nomic_supervised --sampling_strategy cluster_within_domain --num_train_epochs 5 --learning_rate 2e-05 --embedder nomic-ai/nomic-bert-2048 --clustering_model gtr_base --clustering_query_to_doc 1 --ddp_find_unused_parameters 0 --eval_rerank_topk 64 --lr_scheduler_type constant_with_warmup --warmup_steps 100 --disable_dropout 1 --max_seq_length 64 --logging_steps 50 --train_cluster_size {cluster_size} --eval_cluster_size 256 --use_prefix 1 --transductive_corpus_size 64 --save_strategy epoch --logit_scale 50 --max_eval_batches 16 --torch_compile 0 --use_gc 1 --fp16 0 --bf16 1 --eval_steps 2000 --disable_dropout 1 --arch transductive --exp_name 2024-09-18-filter-sweep-13-fixed-9nomic-{cluster_size}-{batch_size}-{num_hard_negatives} --exp_group 2024-09-18-filter-sweep-13-fixed-nomic --use_wandb 1 --hn_filter_model nomic --hn_tune_threshold -1 --hn_filter_precompute_vector 0 --sampling_strategy cluster_within_domain --ddp_share_negatives_between_gpus 0 --max_batch_size_fits_in_memory 256 --use_wandb 1 --num_hard_negatives {num_hard_negatives} --model_state_dict_from_path /fsx-checkpoints/jxm/cde/2024-08-10-transductive-pretrain-transductive-long-12node-filter --ddp_find_unused_parameters 1 --num_eval_rerank_samples 1024" 
