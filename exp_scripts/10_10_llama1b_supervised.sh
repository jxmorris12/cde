...
CMD=" \
    finetune.py --per_device_train_batch_size 256 --per_device_eval_batch_size 256 \
                 ...
                 --exp_name 2024-10-10-supervised-pretrain-llama-1b-2 \
                 --exp_group 2024-10-10-supervised-pretrain-llama-1b-2 \
                 ...
                 --pooling_strategy mean --model_state_dict_from_path /data/home/jxm/cde/saves/2024-10-05-llama-1b-pretrain--.85-epoch/ 
    "
...
LAUNCHER="accelerate launch \
    --config_file fsdp_config_8.yaml \
