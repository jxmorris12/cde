...
CMD="finetune.py --per_device_train_batch_size 2048 --per_device_eval_batch_size 256 \
                 ...
                 --exp_name 2024-11-04-llama-1b-pretrain-8--non-causal \
                 --exp_group 2024-11-04-llama-1b-pretrain-8 \
                 ...
                 --model_state_dict_from_path /fsx-checkpoints/jxm/cde/2024-10-31-llama-1b-pretrain-7--non-causal
                 --seed 5
    "
