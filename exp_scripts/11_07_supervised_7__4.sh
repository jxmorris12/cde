...
CMD=" \
    finetune.py --per_device_train_batch_size 64 --per_device_eval_batch_size 64 \
                 ...
                 --exp_name 2024-11-07-supervised-finetune-llama-1b-7-4 \
                 --exp_group 2024-11-07-supervised-finetune-llama-1b-7-4 \
                 ...
                 --use_in_batch_negatives 0 \
                 --pooling_strategy mean \
                 --model_state_dict_from_path /fsx-checkpoints/jxm/cde/2024-11-04-llama-1b-pretrain-8--non-causal
    "
