...
CMD=" \
    finetune.py --per_device_train_batch_size 64 --per_device_eval_batch_size 64 \
                 --dataset bge --sampling_strategy cluster_within_domain \
                 ...
                 --use_prefix 1 --use_short_prefix 0 --transductive_corpus_size 512 --transductive_tokens_per_document 2 \
                 --logit_scale 50 \
                 --max_eval_batches 16 --torch_compile 0 --use_gc 1 --fp16 0 --bf16 1 \
                 --eval_steps 5000 --disable_dropout 0 --arch transductive \
                 --exp_name 2024-10-17-supervised-pretrain-llama-1b-5 \
                 --exp_group 2024-10-17-supervised-pretrain-llama-1b-5 \
                 --hn_filter_model stella --hn_tune_threshold 1 \
                 --hn_filter_precompute_vector 0 \
                 --ddp_share_negatives_between_gpus 0 --num_hard_negatives 7 \
                 --num_eval_rerank_samples 1024 --save_strategy epoch --save_total_limit 5 \
                 --max_batch_size_fits_in_memory 16 \
                 --max_batch_size_fits_in_memory_first_stage 128 \
                 ...
                 --use_short_prefix 0 \
                 --pool_ignore_instruction_tokens 1 --pool_ignore_contextual_tokens 1 \
                 --pooling_strategy mean \
                 --model_state_dict_from_path /fsx-checkpoints/jxm/cde/2024-10-11-llama-1b-pretrain-2/
    "
