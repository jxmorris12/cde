...
srun torchrun \
    ...
    --nproc_per_node 8 finetune.py --per_device_train_batch_size 512 --per_device_eval_batch_size 256 --use_wandb 1 --dataset nomic_unsupervised --sampling_strategy domain --num_train_epochs 5 --learning_rate 1e-4 --embedder nomic-ai/nomic-bert-2048 --clustering_model gtr_base --clustering_query_to_doc 1 --arch biencoder --ddp_find_unused_parameters 0 --eval_rerank_topk 512 --lr_scheduler_type linear --warmup_steps 5000 --disable_dropout 1 --max_seq_length 512 --train_cluster_size 256 --eval_cluster_size 256 --use_prefix 1 --save_steps 500 --save_strategy steps --logit_scale 50 --max_eval_batches 4 --exp_name 2024-09-20-biencoder-baseline-5epoch --exp_group 2024-09-20-biencoder-pretrain-5epoch --ddp_share_negatives_between_gpus 0 --torch_compile 0 --use_gc 1 --fp16 0 --bf16 1 --eval_steps 1200000000 --logging_steps 50 --use_wandb 1 --hn_tune_threshold 1.0 --ddp_find_unused_parameters 1 --max_batch_size_fits_in_memory 256 --hn_filter_model nomic --save_strategy epoch --save_total_limit 5  --num_eval_rerank_samples 1024