...
CMD=" \
    finetune.py --per_device_train_batch_size 256 --per_device_eval_batch_size 256 \
                 ...
                 --exp_name 2024-11-07-supervised-finetune-llama-1b-7-2 \
                 --exp_group 2024-11-07-supervised-finetune-llama-1b-7-2 \
                 ...
                 --model_state_dict_from_path /fsx-checkpoints/jxm/cde/2024-11-04-llama-1b-pretrain-8--non-causal --use_in_batch_negatives 0
    "
