...
CMD=" \
    finetune.py --per_device_train_batch_size 256 --per_device_eval_batch_size 256 \
                 ...
                 --exp_name 2024-09-31-supervised-final-bge-llama-14-fsdp-3-hn \
                 --exp_group 2024-09-31-supervised-filter-filtered-llama-14-fsdp-3-hn \
                 --hn_filter_model stella --hn_tune_threshold 1 \
                 --hn_filter_precompute_vector 0 \
                 --ddp_share_negatives_between_gpus 0 --num_hard_negatives 3 \
