...
#        --master_port 1338 evaluate_beir.py run "transductive-1epoch-supervised-cluster224-fixed" \
#        --total 1024 \
#        --top_k 256 \
#        --batch_size 512;
# CUDA_VISIBLE_DEVICES=4,5,6,7 torchrun --nproc_per_node 4 \
...
# Hard biencoder with hard batch
# CUDA_VISIBLE_DEVICES=4,5,6,7 torchrun --master_port 1338 --nproc_per_node 4 finetune.py --per_device_train_batch_size 256 --per_device_eval_batch_size 256 --bf16 1 --use_wandb 1 --dataset nomic_supervised --sampling_strategy domain --num_train_epochs 1 --learning_rate 2e-5 --embedder nomic-ai/nomic-embed-text-v1-unsupervised --clustering_model gtr_base --clustering_query_to_doc 1 --automatically_deduplicate_documents 1 --automatically_deduplicate_queries 1 --arch transductive --dataset_info batch --eval_rerank_topk 512 --use_prefix 1 --exp_name 2024-05-03-hard-biencoder-supervised-domain-1epoch --overwrite_output_dir --use_wandb 1 --num_hard_negatives 7 --lr_scheduler_type linear --ddp_share_negatives_between_gpus 0 --use_gc 1 --max_batch_size_fits_in_memory 128 --warmup_steps 400 --logging_steps 50 --train_cluster_size 224 --save_steps 1000 --model_state_dict_from_path /data/saves/tti3/2024-04-15-biencoder-scratch-03-cluster16k-batch4k--1epoch

# Hard biencoder with "Domain"
# CUDA_VISIBLE_DEVICES=4,5,6,7 torchrun --master_port 1338 --nproc_per_node 4 finetune.py --per_device_train_batch_size 256 --per_device_eval_batch_size 256 --bf16 1 --use_wandb 1 --dataset nomic_supervised --sampling_strategy cluster_within_domain --num_train_epochs 1 --learning_rate 2e-5 --embedder nomic-ai/nomic-embed-text-v1-unsupervised --clustering_model gtr_base --clustering_query_to_doc 1 --automatically_deduplicate_documents 1 --automatically_deduplicate_queries 1 --arch transductive --dataset_info batch --eval_rerank_topk 512 --use_prefix 1 --exp_name 2024-05-03-hard-biencoder-supervised-224cluster-1epoch --overwrite_output_dir --use_wandb 1 --num_hard_negatives 7 --lr_scheduler_type linear --ddp_share_negatives_between_gpus 0 --use_gc 1 --max_batch_size_fits_in_memory 128 --warmup_steps 400 --logging_steps 50 --train_cluster_size 224 --save_steps 1000 --model_state_dict_from_path /data/saves/tti3/2024-04-15-biencoder-scratch-03-cluster16k-batch4k--1epoch

# Transductive model with "Domain" 
# CUDA_VISIBLE_DEVICES=4,5,6,7 torchrun --master_port 1338 --nproc_per_node 4 finetune.py --per_device_train_batch_size 256 --per_device_eval_batch_size 256 --bf16 1 --use_wandb 1 --dataset nomic_supervised --sampling_strategy domain --num_train_epochs 1 --learning_rate 2e-5 --embedder nomic-ai/nomic-embed-text-v1-unsupervised --clustering_model gtr_base --clustering_query_to_doc 1 --automatically_deduplicate_documents 1 --automatically_deduplicate_queries 1 --arch transductive --dataset_info batch --eval_rerank_topk 512 --use_prefix 1 --exp_name 2024-05-02-transductive-unsupervised-domain-1epoch--FIXED-HN --overwrite_output_dir --use_wandb 1 --num_hard_negatives 7 --lr_scheduler_type linear --ddp_share_negatives_between_gpus 0 --use_gc 1 --max_batch_size_fits_in_memory 128 --warmup_steps 400 --logging_steps 50 --train_cluster_size 224 --save_steps 1000 --model_state_dict_from_path /data/saves/tti3/backup/2024-04-17-transductive-pretrain-16 --transductive_corpus_size 256

# SD 0.01
# CUDA_VISIBLE_DEVICES=4,5,6,7 torchrun --master_port 1338 --nproc_per_node 4 finetune.py --per_device_train_batch_size 256 --per_device_eval_batch_size 256 --bf16 1 --use_wandb 1 --dataset nomic_supervised --sampling_strategy cluster_within_domain --num_train_epochs 1 --learning_rate 2e-5 --embedder nomic-ai/nomic-embed-text-v1-unsupervised --clustering_model gtr_base --clustering_query_to_doc 1 --automatically_deduplicate_documents 1 --automatically_deduplicate_queries 1 --arch transductive --dataset_info batch --eval_rerank_topk 512 --use_prefix 1 --exp_name 2024-05-02-transductive-unsupervised-cluster224-1epoch-supervised-cluster224--FIXED-HN-sd0.01 --overwrite_output_dir --use_wandb 1 --num_hard_negatives 7 --lr_scheduler_type linear --ddp_share_negatives_between_gpus 0 --use_gc 1 --max_batch_size_fits_in_memory 128 --warmup_steps 400 --logging_steps 50 --train_cluster_size 224 --save_steps 1000 --model_state_dict_from_path /data/saves/tti3/backup/2024-04-17-transductive-pretrain-16 --transductive_corpus_size 256 --transductive_sequence_dropout_prob 0.01

# SD 0.1
# CUDA_VISIBLE_DEVICES=4,5,6,7 torchrun --master_port 1338 --nproc_per_node 4 finetune.py --per_device_train_batch_size 256 --per_device_eval_batch_size 256 --bf16 1 --use_wandb 1 --dataset nomic_supervised --sampling_strategy cluster_within_domain --num_train_epochs 1 --learning_rate 2e-5 --embedder nomic-ai/nomic-embed-text-v1-unsupervised --clustering_model gtr_base --clustering_query_to_doc 1 --automatically_deduplicate_documents 1 --automatically_deduplicate_queries 1 --arch transductive --dataset_info batch --eval_rerank_topk 512 --use_prefix 1 --exp_name 2024-05-02-transductive-unsupervised-cluster224-1epoch-supervised-cluster224--FIXED-HN-sd0.1 --overwrite_output_dir --use_wandb 1 --num_hard_negatives 7 --lr_scheduler_type linear --ddp_share_negatives_between_gpus 0 --use_gc 1 --max_batch_size_fits_in_memory 128 --warmup_steps 400 --logging_steps 50 --train_cluster_size 224 --save_steps 1000 --model_state_dict_from_path /data/saves/tti3/backup/2024-04-17-transductive-pretrain-16 --transductive_corpus_size 256 --transductive_sequence_dropout_prob 0.1

# SD 0.2
# CUDA_VISIBLE_DEVICES=4,5,6,7 torchrun --master_port 1338 --nproc_per_node 4 finetune.py --per_device_train_batch_size 256 --per_device_eval_batch_size 256 --bf16 1 --use_wandb 1 --dataset nomic_supervised --sampling_strategy cluster_within_domain --num_train_epochs 1 --learning_rate 2e-5 --embedder nomic-ai/nomic-embed-text-v1-unsupervised --clustering_model gtr_base --clustering_query_to_doc 1 --automatically_deduplicate_documents 1 --automatically_deduplicate_queries 1 --arch transductive --dataset_info batch --eval_rerank_topk 512 --use_prefix 1 --exp_name 2024-05-02-transductive-unsupervised-cluster224-1epoch-supervised-cluster224--FIXED-HN-sd0.2 --overwrite_output_dir --use_wandb 1 --num_hard_negatives 7 --lr_scheduler_type linear --ddp_share_negatives_between_gpus 0 --use_gc 1 --max_batch_size_fits_in_memory 128 --warmup_steps 400 --logging_steps 50 --train_cluster_size 224 --save_steps 1000 --model_state_dict_from_path /data/saves/tti3/backup/2024-04-17-transductive-pretrain-16 --transductive_corpus_size 256 --transductive_sequence_dropout_prob 0.2
