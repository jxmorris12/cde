...
CMD="finetune.py --per_device_train_batch_size 2048 --per_device_eval_batch_size 256 \
                 ...
                 --eval_rerank_topk 512 --lr_scheduler_type constant \
                 --warmup_steps 160 --max_seq_length 512 \
                 --logging_steps 1 --train_cluster_size 2048 --eval_cluster_size 512 \
                 ...
                 --exp_name 2024-10-26-llama-1b-pretrain-6--non-causal \
                 --exp_group 2024-10-26-llama-1b-pretrain-6 \
                 ...
                 --num_eval_rerank_samples 1024 --save_strategy steps --save_steps 500 --save_total_limit 1 \
                 ...
                 --model_state_dict_from_path "/fsx-checkpoints/jxm/cde/2024-10-21-llama-1b-pretrain-5--non-causal" \
                 --seed 3
    "
