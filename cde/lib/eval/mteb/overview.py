...
from cde.lib.eval.mteb.abstasks import AbsTask
from cde.lib.eval.mteb.abstasks.languages import (
    ISO_TO_LANGUAGE,
    ISO_TO_SCRIPT,
    path_to_lang_codes,
    path_to_lang_scripts,
)
from cde.lib.eval.mteb.abstasks.TaskMetadata import TASK_CATEGORY, TASK_DOMAIN, TASK_TYPE
from cde.lib.eval.mteb.tasks import *  # import all tasks
