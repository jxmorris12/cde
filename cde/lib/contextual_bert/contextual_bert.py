...
from cde.lib.nomic_bert.attention import FlashAttention
from cde.lib.nomic_bert.block import MLP, GatedMLP
from cde.lib.nomic_bert.embedding import BertEmbeddings
from cde.lib.nomic_bert.bert import remap_bert_state_dict
from cde.lib.nomic_bert.model_utils import filter_shapes, state_dict_from_pretrained
...
class ContextualBlock(nn.Module):
    ...
    def forward(
        ...
        cross_attention_x = self.cross_attn_norm_1(hidden_states)
